...
export default function ShiftsScreen() {
  const { fetchAvailableShifts, fetchUserBookings, userBookings, filteredShifts, isLoading } = useShiftsStore();
      ...
      <View className="flex-row justify-between items-center">
        ...
        <View className="flex-row gap-2">
          ...
          {booking.status === 'pending' && (
            <TouchableOpacity className="bg-red-600 px-3 py-2 rounded-lg">
